...
class Cal:
    def __init__(self,master):
        ...
        self.euation=StringVar()
        self.entry_value=''
        Entry(width=17,bg='#ccddff',font=('Arial Bold',28),textvariable=self.euation).place(x=0,y=0)
        ...
        Button(width=11,height=4,text='C',relief='flat',command=lambda:self.clear()).place(x=0,y=350)  

    def show(self,value):
        self.entry_value+=str(value)
        self.euation.set(self.entry_value)
